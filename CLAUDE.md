...
**Decisiones**
- [docs/adr/](docs/adr/) — ADRs 001–077, una decisión por archivo con su porqué ([índice](docs/adr/README.md)).
...
- **ADRs** ([docs/adr/](docs/adr/)) — decisiones de arquitectura con su porqué (ADR-001..077).
