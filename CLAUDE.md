...
**Decisiones**
- [docs/adr/](docs/adr/) — ADRs 001–065, una decisión por archivo con su porqué ([índice](docs/adr/README.md)).
...
- **ADRs** ([docs/adr/](docs/adr/)) — decisiones de arquitectura con su porqué (ADR-001..065).
