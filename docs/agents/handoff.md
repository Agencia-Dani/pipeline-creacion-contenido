...
|---|---|---|---|
| **A** Auditoría del pipeline vivo | mapa nodo/campo/página + reconciliar repo↔live + decisión §3 (ADR) | Dev 1 | 🔧 **A.1 ✅ · A.4 ✅** (la cerró el re-import) · **A.2 🔧** (sigue en [mapa-campos.md §4](./mapa-campos.md)) · A.3/A.5 ⬜ |
